 ...
 * @LastEditTime: 2019-08-25 14:18:46
...
" @click-right-icon="forget" class="old-psd" ref="oldPsd" @input="clearErr" />
      <van-field v-model="password.newPassword" left-icon="bookmark-o" :right-icon="isShow?'eye-o':'closed-eye'" :type="isShow?'text':'password'" @click-right-icon="eye" label="新密码" placeholder="请输入新密码" required clearable @blur="check" @input="clearErr" />
      <van-field v-model="password.repeatPassword" left-icon="edit" :type="isShow?'text':'password'" label="确认密码" placeholder="请确认新密码" required clearable :error-message="errMsg" @blur="check" @input="clearErr" ref="repeatPsd" />
    </van-cell-group>
